...
class Alert(BaseModel):
    ...
    opened_at: datetime = Field(..., description="Timestamp when alert was triggered")
    resolved_at: Optional[datetime] = Field(default=None, description="Timestamp when risk subsided")
